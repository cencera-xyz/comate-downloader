...
const WIN_PORTABLE_URL = 'https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.100/cencera-comate-portable_0.1.100_x64.exe';
const LINUX_DEB_URL = 'https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.100/cencera-comate_0.1.100_amd64.deb';
