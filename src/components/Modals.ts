...
export function renderModals(): string {
  ...
  <!-- MODAL: CHANGELOG / RELEASE NOTES (V0.1.104) -->
  <div class="modal-backdrop" id="changelog-modal" role="dialog" aria-modal="true" aria-labelledby="cl-modal-title">
    <div class="modal-card">
      <div class="modal-header">
        <div class="modal-title-group">
          <span class="modal-glow-dot"></span>
          <h3 class="modal-title" id="cl-modal-title">Release Notes — Comate V0.1.104 BASE</h3>
        </div>
      ...
      <div class="modal-body changelog-body">
        <div class="cl-meta-header">
          <span class="cl-version-pill">V0.1.104 BASE</span>
          <span class="cl-date">Release Tag: <code>V0.1.104</code></span>
          <a href="https://github.com/cencera-xyz/comate-downloader/releases/tag/V0.1.104" target="_blank" rel="noopener noreferrer" class="cl-commit">View on GitHub ↗</a>
        </div>
