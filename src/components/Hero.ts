    ...
    <div class="hero-container">
      ...
      <div class="hero-badge-wrap">
        <button class="hero-pill-badge" id="hero-badge-trigger" aria-label="View Release notes">
          ...
          <span class="pill-text">Comate V0.1.104 BASE</span>
        ...
        <div class="primary-cta-dropdown-wrap">
          <a href="#downloads" class="clay-primary-btn" id="hero-download-btn">
            ...
            <span class="btn-content">
              ...
              <span class="btn-subtext" id="hero-download-sub">V0.1.104 Portable (.exe) • 107 MB</span>
            </span>
          </a>
          ...
          <div class="cta-dropdown-menu" id="cta-dropdown-menu">
            <div class="dropdown-header">Available Packages (V0.1.104)</div>
            <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate-portable_0.1.104_x64.exe" class="dropdown-item" data-os="windows" target="_blank" rel="noopener noreferrer">
              <span class="dd-title">Windows Portable (.exe) <span class="dd-badge-active">107 MB</span></span>
            </a>
            <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate-setup_0.1.104_x64.exe" class="dropdown-item" data-os="windows" target="_blank" rel="noopener noreferrer">
              <span class="dd-title">Windows Setup (.exe) <span class="dd-badge-active">108 MB</span></span>
            </a>
            <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate_0.1.104_amd64.deb" class="dropdown-item" data-os="linux" target="_blank" rel="noopener noreferrer">
              <span class="dd-title">Linux Debian / Ubuntu (.deb) <span class="dd-badge-active">95.7 MB</span></span>
            </a>
            <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate_0.1.104_x86_64.AppImage" class="dropdown-item" data-os="linux" target="_blank" rel="noopener noreferrer">
