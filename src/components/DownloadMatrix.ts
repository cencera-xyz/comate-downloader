  ...
  <section class="downloads-section" id="downloads">
    <div class="section-container">
      <div class="section-header-center">
        ...
        <h2 class="section-headline">Download Comate V0.1.104 BASE</h2>
      ...
      <div class="download-platform-tabs">
        <button class="dl-tab active" data-platform="windows" id="tab-btn-windows">
          ...
          <span>Windows</span>
          <span class="badge-tab-active">V0.1.104</span>
        </button>
        <button class="dl-tab" data-platform="linux" id="tab-btn-linux">
          <span class="dl-tab-icon">${BrandIcons.Linux({ size: 15 })}</span>
          <span>Linux</span>
        </button>
        <button class="dl-tab dl-tab-disabled" data-platform="macos" id="tab-btn-macos" title="macOS / iOS build is not released yet in V0.1.104">
      ...
      <div class="download-cards-container">
          ...
          <div class="dl-grid-two">
            <div class="dl-release-card recommended">
              ...
              <div class="dl-meta-row">
                <span>Version: <strong>V0.1.104</strong></span>
                <span>Size: <strong>95.7 MB</strong></span>
                <span>Arch: <strong>amd64</strong></span>
              </div>
              <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate_0.1.104_amd64.deb" class="glow-download-button" data-filename="cencera-comate_0.1.104_amd64.deb" target="_blank" rel="noopener noreferrer">
            ...
            <div class="dl-release-card">
              ...
              <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate_0.1.104_x86_64.AppImage" class="glass-download-button" data-filename="cencera-comate_0.1.104_x86_64.AppImage" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
        ...
        <div class="platform-dl-panel active" id="panel-windows">
          <div class="dl-grid-two">
            <div class="dl-release-card recommended">
              ...
              <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate-portable_0.1.104_x64.exe" class="glow-download-button" data-filename="cencera-comate-portable_0.1.104_x64.exe" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
            ...
            <div class="dl-release-card">
              ...
              <a href="https://github.com/cencera-xyz/comate-downloader/releases/download/V0.1.104/cencera-comate-setup_0.1.104_x64.exe" class="glass-download-button" data-filename="cencera-comate-setup_0.1.104_x64.exe" target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
        ...
        <!-- macOS / iOS Downloads (Disabled — Not in V0.1.104 Release) -->
        <div class="platform-dl-panel" id="panel-macos">
          <div class="dl-grid-two">
            <div class="dl-release-card card-disabled">
              <div class="rec-pill pill-disabled">Unavailable in V0.1.104</div>
              <div class="dl-card-head">
                <h3 class="dl-pkg-name">macOS Apple Silicon (.dmg)</h3>
                <span class="dl-tag tag-disabled">arm64</span>
              </div>
              <p class="dl-pkg-desc">Apple Silicon (M1/M2/M3/M4) build is currently undergoing compilation and signature verification. Not available in V0.1.104.</p>
              <div class="dl-meta-row">
                <span>Status: <strong>Coming in future release</strong></span>
                <span>OS: <strong>macOS 12.0+ / iOS</strong></span>
              </div>
              <button class="glow-download-button btn-disabled" disabled aria-disabled="true" title="macOS / iOS version is not released in V0.1.104">
            ...
            <div class="dl-release-card card-disabled">
              ...
              <p class="dl-pkg-desc">Universal x86_64 DMG package for Intel-based Macs. Currently in active development and not available in V0.1.104.</p>
              <div class="dl-meta-row">
                <span>Status: <strong>Coming in future release</strong></span>
                <span>OS: <strong>macOS 11.0+</strong></span>
              </div>
              <button class="glass-download-button btn-disabled" disabled aria-disabled="true" title="macOS / iOS version is not released in V0.1.104">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>
                <span>macOS / iOS Version Disabled</span>
              </button>
              <div class="dl-release-notice">
